...
def render_graph_DefaultRenderGraph():
    ...
    g.addEdge('RealtimeStochasticLightcuts.albedo', 'SVGFPass.Albedo')
    g.addEdge('RealtimeStochasticLightcuts.color', 'SVGFPass.Color')
