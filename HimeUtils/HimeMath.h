...
namespace Falcor
{
    ...
    */
    ...
    inline uint deinterleave_30bits_uint(uint x)
    {
    ...
    inline uint3 deinterleave_30bits_uint3(uint x)
    {
        uint3 v;
    ...
    inline uint interleave_30bits_uint(uint x)
    {
    ...
    inline uint interleave_30bits_uint3(uint3 v)
    {
