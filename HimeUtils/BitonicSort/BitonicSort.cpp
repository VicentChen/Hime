...
namespace Falcor
{
    ...
    void HimeBitonicSort::sort(RenderContext* pRenderContext, Buffer::SharedPtr pKeyIndexList, uint32_t elementCount, uint32_t counterOffset, bool IsPartiallyPreSorted, bool isAscending)
    {
